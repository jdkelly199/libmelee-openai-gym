...
class MeleeEnv(gym.GoalEnv):
  ...
  def __init__(self, ai=0, cpu=0, enemy_level=1, training_iterations=1000000):
    ...
    self.observation_space = spaces.Dict(
        {
            "observation": spaces.Box(np.array([0, 0, -1000, -1000, 0, 0, 0, 0, 0, 0, 0, 0, -1000, -1000, 0, 0, 0, 0, 0, 0, -1]), #player 1(stock, percent, x, y, facing, on_ground, off_stage, action, jumps_left, invulnerable), player 2(stock, percent, x, y, facing, on_ground, off_stage, action, jumps_left, invulnerable)
                        np.array([4, 1000, 1000, 1000, 1, 1, 1, 500, 10, 1, 4, 1000, 1000, 1000, 1, 1, 1, 500, 10, 1, 1])), #player 1(stock, percent, x, y, facing, on_ground, off_stage, action, jumps_left, invulnerable), #player 2(stock, percent, x, y, facing, on_ground, off_stage, action, jumps_left, invulnerable)
            "achieved_goal": spaces.Box(np.array([0, 0, -1000, -1000, 0, 0, 0, 0, 0, 0, 0, 0, -1000, -1000, 0, 0, 0, 0, 0, 0, -1]), #player 1(stock, percent, x, y, facing, on_ground, off_stage, action, jumps_left, invulnerable), player 2(stock, percent, x, y, facing, on_ground, off_stage, action, jumps_left, invulnerable)
                        np.array([4, 1000, 1000, 1000, 1, 1, 1, 500, 10, 1, 4, 1000, 1000, 1000, 1, 1, 1, 500, 10, 1, 1])),
            "desired_goal": spaces.Box(np.array([0, 0, -1000, -1000, 0, 0, 0, 0, 0, 0, 0, 0, -1000, -1000, 0, 0, 0, 0, 0, 0, -1]), #player 1(stock, percent, x, y, facing, on_ground, off_stage, action, jumps_left, invulnerable), player 2(stock, percent, x, y, facing, on_ground, off_stage, action, jumps_left, invulnerable)
                        np.array([4, 1000, 1000, 1000, 1, 1, 1, 500, 10, 1, 4, 1000, 1000, 1000, 1, 1, 1, 500, 10, 1, 1])),
        })
    ...
    self.desired_goal = np.array([4, 0, 0, 0, 0, 0, 0, 0, 0, 0, 3, 0, -1000, -1000, 0, 0, 0, 0, 0, 0, 0])
  ...
  def compute_reward(self, achieved_goal, desired_goal, info={}):
      ...
      if achieved_goal[10] == desired_goal[10]:
          if achieved_goal[10] == self.desired_goal[10]:
